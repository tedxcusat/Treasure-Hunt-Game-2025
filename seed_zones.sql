...
(2, 'University Library', 10.0418, 76.3283, 25, '5678', ARRAY['Opposite the SMS building', 'Center of knowledge'], 'David''s parents have three sons: Snap, Crackle, and...?', '["David", "Pop", "Chip", "Dale"]'::jsonb),
(3, 'Butterfly Park', 10.0425, 76.3256, 30, '9012', ARRAY['Near the Dept. of Applied Chemistry', 'Nature spot'], 'What has many keys but can''t open a single lock?', '["Piano", "Map", "Chest", "Door"]'::jsonb),
(4, 'SMS (School of Mgmt. Studies)', 10.0409, 76.3284, 25, '3456', ARRAY['Next to the Main Circle', 'Management Block'], 'The more of this there is, the less you see. What is it?', '["Darkness", "Fog", "Light", "Smoke"]'::jsonb),
...
(6, 'CITTIC', 10.0435, 76.3242, 25, '2468', ARRAY['Near Guest House/TBI', 'Innovation Hub'], 'I speak without a mouth and hear without ears. I have no body, but I come alive with wind. What am I?', '["Echo", "Ghost", "Cloud", "Shadow"]'::jsonb)
